...
## Package map (11 sub-packages + the meta package)
...
| `Honua.Sdk.Grpc` | [src/Honua.Sdk.Grpc/README.md](../src/Honua.Sdk.Grpc/README.md) | `IHonuaGrpcClient`, `HonuaGrpcClient`, `HonuaGrpcClientOptions`, `QueryFeaturesRequest`, `QueryFeaturesResponse`, `ApplyEditsRequest` | [api/Honua.Sdk.Grpc.html](https://honua-io.github.io/honua-sdk-dotnet/api/Honua.Sdk.Grpc.html) |
