...
| `Honua.Sdk.Abstractions` | [src/Honua.Sdk.Abstractions/README.md](../src/Honua.Sdk.Abstractions/README.md) | `IHonuaFeatureQueryClient`, `IHonuaFeatureEditClient`, `IHonuaFeatureAttachmentClient`, `IHonuaFeatureStreamClient`, `SourceDescriptor`, `SourceQuery`, `HonuaConsoleShellDescriptor`, `HonuaEnvironmentProfile`, `HonuaException`, `HonuaConfigurationException`, `HonuaPluginManifest` | [api/Honua.Sdk.Abstractions.html](https://honua-io.github.io/honua-sdk-dotnet/api/Honua.Sdk.Abstractions.html) |
