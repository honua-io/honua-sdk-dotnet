...
/// </summary>
public sealed class HonuaFeaturesClientOptions
{
    /// <summary>
    ...
    internal static void ValidateBaseAddress(Uri? baseAddress)
    {
        ...
        {
            throw new InvalidOperationException("Honua features base address must be configured.");
        }

        if (!baseAddress.IsAbsoluteUri)
        {
            throw new InvalidOperationException("Honua features base address must be an absolute URI.");
        }
        ...
        {
            throw new InvalidOperationException("Honua features base address must use HTTP or HTTPS.");
        }
    }
