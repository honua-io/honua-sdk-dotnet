...
/// <summary>
/// Exception thrown when the Honua Console Share API returns an error HTTP status code.
/// </summary>
public sealed class HonuaConsoleShareApiException : Honua.Sdk.Abstractions.HonuaException
{
    /// <summary>
    /// Initializes a new instance of the <see cref="HonuaConsoleShareApiException"/> class.
    /// </summary>
    public HonuaConsoleShareApiException()
        : this(HttpStatusCode.InternalServerError, "Console Share API request failed.")
    {
    }
    ...
    public HonuaConsoleShareApiException(string message)
        : this(HttpStatusCode.InternalServerError, message)
    {
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="HonuaConsoleShareApiException"/> class with an inner exception.
    /// </summary>
    /// <param name="message">A human-readable error message.</param>
    /// <param name="innerException">The inner exception that caused this exception.</param>
    public HonuaConsoleShareApiException(string message, Exception innerException)
