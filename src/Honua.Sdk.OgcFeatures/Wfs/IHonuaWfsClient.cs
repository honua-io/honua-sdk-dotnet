...
public interface IHonuaWfsClient
{
    ...
    /// </summary>
    Task<WfsCapabilities> GetCapabilitiesAsync(CancellationToken cancellationToken = default);
    ...
    Task<WfsFeatureTypeSchema> DescribeFeatureTypeAsync(string typeName, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    Task<WfsFeatureCollection> GetFeaturesAsync(GetFeaturesRequest request, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    Task<long?> GetFeatureCountAsync(string typeName, string? filter = null, CancellationToken cancellationToken = default);
