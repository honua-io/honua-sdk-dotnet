...
public interface IHonuaOgcFeaturesClient
{
    ...
    Task<OgcLandingPage> GetLandingPageAsync(CancellationToken cancellationToken = default);
    ...
    Task<OgcConformance> GetConformanceAsync(CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<OgcCollection>> ListCollectionsAsync(CancellationToken cancellationToken = default);
    ...
    Task<OgcCollection> GetCollectionAsync(string collectionId, CancellationToken cancellationToken = default);
    ...
    Task<OgcQueryables> GetQueryablesAsync(string collectionId, CancellationToken cancellationToken = default);
    ...
    Task<OgcFeatureCollection> GetItemsAsync(string collectionId, OgcItemsParams? query = null, CancellationToken cancellationToken = default);
    ...
    Task<OgcFeature> GetItemAsync(string collectionId, string featureId, CancellationToken cancellationToken = default);
    ...
    IAsyncEnumerable<OgcFeatureCollection> GetItemsPagesAsync(string collectionId, OgcItemsParams? query = null, CancellationToken cancellationToken = default);
    ...
    Task<HttpResponseMessage> GetItemsRawAsync(string collectionId, OgcItemsParams? query = null, CancellationToken cancellationToken = default);
}
