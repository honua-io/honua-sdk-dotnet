...
namespace Honua.Sdk.Studio.Models;

/// <summary>
/// Minimal projection of the RFC 7807 problem-details document the Studio
/// endpoints return on error, used to surface a meaningful message on
/// <see cref="Exceptions.HonuaStudioApiException"/>.
/// </summary>
internal sealed record StudioProblem
{
