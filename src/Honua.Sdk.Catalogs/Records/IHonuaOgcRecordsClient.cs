...
public interface IHonuaOgcRecordsClient
{
    ...
    Task<OgcRecordsLandingPage> GetLandingPageAsync(CancellationToken cancellationToken = default);
    ...
    Task<OgcRecordsConformance> GetConformanceAsync(CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<OgcRecordsCollection>> ListCollectionsAsync(CancellationToken cancellationToken = default);
    ...
    Task<OgcRecordsCollection> GetCollectionAsync(string collectionId, CancellationToken cancellationToken = default);
    ...
    Task<OgcRecord> GetRecordAsync(string collectionId, string recordId, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>A caller-owned JSON document.</returns>
    Task<JsonDocument> GetRecordJsonAsync(string collectionId, string recordId, CancellationToken cancellationToken = default);
