...
using Honua.Sdk.OgcRecords.Exceptions;
...
public sealed class HonuaOgcRecordsClient : IHonuaOgcRecordsClient
{
    ...
    /// <inheritdoc />
    public async Task<OgcRecordsLandingPage> GetLandingPageAsync(CancellationToken ct = default)
    {
    ...
    /// <inheritdoc />
    public async Task<OgcRecordsConformance> GetConformanceAsync(CancellationToken ct = default)
    {
    ...
    /// <inheritdoc />
    public async Task<IReadOnlyList<OgcRecordsCollection>> ListCollectionsAsync(CancellationToken ct = default)
    {
    ...
    /// <inheritdoc />
    public async Task<OgcRecordsCollection> GetCollectionAsync(string collectionId, CancellationToken ct = default)
    {
    ...
    public Task<OgcRecordCollection> SearchAsync(
        ...
        OgcRecordsQuery? query = null,
        CancellationToken ct = default)
        => GetRecordsAsync(collectionId, query, ct);
        ...
        [EnumeratorCancellation] CancellationToken ct = default)
    {
        ...
        var page = await GetRecordsAsync(collectionId, query, ct).ConfigureAwait(false);
        yield return page;
