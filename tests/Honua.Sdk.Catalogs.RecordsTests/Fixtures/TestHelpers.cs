...
namespace Honua.Sdk.Catalogs.RecordsTests.Fixtures;

internal static class TestHelpers
{
    public static HonuaOgcRecordsClient CreateOgcRecordsClient(
        Func<HttpRequestMessage, Task<HttpResponseMessage>> handler)
    {
        ...
        return new HonuaOgcRecordsClient(httpClient);
    }
