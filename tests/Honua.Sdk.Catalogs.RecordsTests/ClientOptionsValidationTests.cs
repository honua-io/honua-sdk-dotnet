...
public sealed class ClientOptionsValidationTests
{
    ...
    public void ValidateBaseAddress_NullUri_Throws()
    {
        Assert.Throws<HonuaConfigurationException>(
            () => HonuaOgcRecordsClientOptions.ValidateBaseAddress(null));
    }
    ...
    {
        Assert.Throws<HonuaConfigurationException>(
            () => HonuaOgcRecordsClientOptions.ValidateBaseAddress(new Uri("/relative", UriKind.Relative)));
    }
    ...
    {
        Assert.Throws<HonuaConfigurationException>(
            () => HonuaOgcRecordsClientOptions.ValidateBaseAddress(new Uri(value)));
    }
    ...
    {
        Assert.Throws<HonuaConfigurationException>(
            () => HonuaOgcRecordsClientOptions.ValidateTimeout(TimeSpan.FromMilliseconds(millis)));
    }
    ...
    {
        Assert.Throws<HonuaConfigurationException>(
            () => HonuaOgcRecordsClientOptions.ValidateTimeout(TimeSpan.FromHours(24)));
    }

    [Fact]
    public void ValidateTimeout_AcceptsTypicalValue()
    {
        HonuaOgcRecordsClientOptions.ValidateTimeout(TimeSpan.FromSeconds(30));
    }
    ...
    {
        var options = new HonuaOgcRecordsClientOptions { MaxRetryAttempts = attempts };
    ...
    {
        Assert.True(HonuaOgcRecordsClientOptions.RequiresHttpsForAuthentication(null));
    }

    [Fact]
    public void RequiresHttpsForAuthentication_Https_ReturnsFalse()
    {
        Assert.False(HonuaOgcRecordsClientOptions.RequiresHttpsForAuthentication(new Uri("https://example.com")));
    }
    ...
    {
        Assert.False(HonuaOgcRecordsClientOptions.RequiresHttpsForAuthentication(new Uri(value)));
    }

    [Fact]
    public void RequiresHttpsForAuthentication_RemoteHttp_ReturnsTrue()
    {
        Assert.True(HonuaOgcRecordsClientOptions.RequiresHttpsForAuthentication(new Uri("http://example.com")));
    }

    [Fact]
    public void IsLocalDevelopmentHttp_HttpsScheme_ReturnsFalse()
    {
        Assert.False(HonuaOgcRecordsClientOptions.IsLocalDevelopmentHttp(new Uri("https://localhost:5000")));
    }

    [Fact]
    public void IsLocalDevelopmentHttp_LoopbackHttp_ReturnsTrue()
    {
        Assert.True(HonuaOgcRecordsClientOptions.IsLocalDevelopmentHttp(new Uri("http://127.0.0.1")));
    }
}
