...
public sealed class ClientOptionsValidationTests
{
    ...
    public void ValidateBaseAddress_NullUri_Throws()
    {
        Assert.Throws<HonuaConfigurationException>(
            () => HonuaAdminClientOptions.ValidateBaseAddress(null));
    }
    ...
    {
        Assert.Throws<HonuaConfigurationException>(
            () => HonuaAdminClientOptions.ValidateBaseAddress(new Uri("/relative", UriKind.Relative)));
    }
    ...
    {
        Assert.Throws<HonuaConfigurationException>(
            () => HonuaAdminClientOptions.ValidateBaseAddress(new Uri(value)));
    }
    ...
    {
        Assert.Throws<HonuaConfigurationException>(
            () => HonuaAdminClientOptions.ValidateTimeout(TimeSpan.FromMilliseconds(millis)));
    }
    ...
    {
        Assert.Throws<HonuaConfigurationException>(
            () => HonuaAdminClientOptions.ValidateTimeout(TimeSpan.FromHours(24)));
    }

    [Fact]
    public void ValidateTimeout_AcceptsTypicalValue()
    {
        HonuaAdminClientOptions.ValidateTimeout(TimeSpan.FromSeconds(30));
    }
    ...
    {
        var options = new HonuaAdminClientOptions { MaxRetryAttempts = attempts };
    ...
    {
        Assert.True(HonuaAdminClientOptions.RequiresHttpsForAuthentication(null));
    }

    [Fact]
    public void RequiresHttpsForAuthentication_Https_ReturnsFalse()
    {
        Assert.False(HonuaAdminClientOptions.RequiresHttpsForAuthentication(new Uri("https://example.com")));
    }
    ...
    {
        Assert.False(HonuaAdminClientOptions.RequiresHttpsForAuthentication(new Uri(value)));
    }

    [Fact]
    public void RequiresHttpsForAuthentication_RemoteHttp_ReturnsTrue()
    {
        Assert.True(HonuaAdminClientOptions.RequiresHttpsForAuthentication(new Uri("http://example.com")));
    }

    [Fact]
    public void IsLocalDevelopmentHttp_HttpsScheme_ReturnsFalse()
    {
        Assert.False(HonuaAdminClientOptions.IsLocalDevelopmentHttp(new Uri("https://localhost:5000")));
    }

    [Fact]
    public void IsLocalDevelopmentHttp_LoopbackHttp_ReturnsTrue()
    {
        Assert.True(HonuaAdminClientOptions.IsLocalDevelopmentHttp(new Uri("http://127.0.0.1")));
    }
}
